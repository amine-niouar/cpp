...
def push_swap(testcases,much,display):
     ...
     out = subprocess.check_output("./push_swap/push_swap " + buffer + " | ./checker_Mac " + buffer, shell=True)
     output = subprocess.check_output("./push_swap/push_swap "+buffer+" | wc -l", shell=True)
     lines = out.split("\n")
